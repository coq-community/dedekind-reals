...
Require Import QOrderedType Qpower.
...
Lemma trisect_many (x : R) (q : Qpositive) (n : nat) :
  straddle x q -> straddle x (two_thirds_pow n q).
Proof.
  induction n.
  intro.
  setoid_replace (two_thirds_pow 0 q) with q.
...
destruct (two_third_power_small () as [n G].
