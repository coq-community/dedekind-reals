...
# coq_makefile Archimedean.v Arithmetic.v Cut.v Lipschitz.v Metric.v MiscLemmas.v 
#
...
VFILES:= MiscLemmas.v Cut.v Arithmetic.v Order.v Completeness.v Archimedean.v
